    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>How Gras Savoye Works</h2>
          <p>Gras Savoye doesn’t do the traditional insurance model. We treat the premiums you pay
            as if it’s your money, not ours. Everything becomes simple and transparent. We take a
            flat fee, pay claims super fast, and give back what’s left to causes you care about.
            <br>
            <button class="btn btn-primary">Learn More</button>
          </p>
        </div>
        <div class="section-title"><h2>How can we help?</h2></div>
        <div class="row">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              <li><a href="#">Call to get a quote</a></li>
